...
export const projects: Project[] = [
  {
    ...
    title: "Data Analysis and Visualization using Virtual Reality",
  ...
  },
  {
    ...
    liveUrl: null,
    posterUrl: null,
    paperUrl: "/penguin.pdf",
    technologies: ["R", "Bootstrap Resampling", "Logistic Regression", "Decision Trees"],
    metrics: {
